...
<div class="login-form">
     ...
     <form  onsubmit="return validate()"  action="KeyGenerate" method="post">
        <h3 style="text-align: center">Enter Key</h3>
        <input type="password" id="email" placeholder="EnterKey" name="skey" class="box">
        <input type="submit" class="btn" value="Decrypt File">
        <i class="fas fa"></i>
    </form>
